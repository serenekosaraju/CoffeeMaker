...
Please run coffee_machine.py which
...
#After a few attempts of buying, we get a message saying it is not possible to buy some items due to some ingredients not being available